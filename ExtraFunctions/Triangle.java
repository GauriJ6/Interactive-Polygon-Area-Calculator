...
public class Triangle extends PolygonShape {
    ...
    public void calculateProperties() { 
        ...
        angles[0] = calculateAngle(lengths[0], lengths[2], lengths[1]); 
        angles[1] = calculateAngle(lengths[0], lengths[1], lengths[2]); 
        angles[2] = calculateAngle(lengths[1], lengths[2], lengths[0]); 
    }
