...
public class Quadrilateral extends PolygonShape {
    ...
    public void calculateProperties() {
        ...
        double d1 = Math.hypot(xPoints[2] - xPoints[0], yPoints[2] - yPoints[0]); 
        double d2 = Math.hypot(xPoints[3] - xPoints[1], yPoints[3] - yPoints[1]); 

        angles[0] = calculateAngle(lengths[0], lengths[3], d2); 
        angles[1] = calculateAngle(lengths[0], lengths[1], d1); 
        angles[2] = calculateAngle(lengths[1], lengths[2], d2);
        angles[3] = calculateAngle(lengths[2], lengths[3], d1); 
    }
